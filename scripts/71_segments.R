...
voiced_Cs <- c("l", "r", "n_j", "w~", "m_w", "l`", "n", "m:", "r_j", "4", "J", "5", "l_j", "j", "N:", "m_j", "w", "l:", "m", "j:", "N", "n_jn", "J_+", "w_j", "n:", "r\\`", "mm", "nn", "ll", "rr", "ww", "jj", "r_w", "l_w", "r\\", "n`", "w:", "Nm", "J:", "H", "r:", "P", "n_t", "l_t", "L", "N_w", "n_w", "j~", "r`", "m_p", "n_p", "z_j", "G", "z\\", "z`", "B", "z", "R", "R_j", "B_j", "v_j", "j\\", "Z", "v", "r\\_r", "r\\:_r", "?\\", "D", "Z_w", "R_w",  "z_w", "d", "dz\\", "b_w", "dZ_j", "g", "J\\", "dz`", "dz", "b_j", "b", "d_<", "b_<", "bb", "dd", "d`d`", "gg", "g_wg_w", "J\\J\\", "d_j", "d_j_<", "g_j", "g_w", "d`", "d:", "dZ", "b:", "d:_j", "J\\:", "g:", "g:_w", "gb", "b_j_<", "dZ_w", "d_d", "d_w_<", "d:`", "d_w","", "")
voiceless_Cs <- c("l_0", "r_0", "n_0", "J_0", "m_0", "N_0", "h", "K", "X", "S","X:", "x:", "C", "S_j", "X_>", "x", "s", "s:", "s\\", "S:", "f_w", "T", "s_j", "s`", "X:_w", "X\\", "p\\", "X_w", "s\\:", "SS", "ss", "ff", "s_h", "S_h", "f_h", "s\\_h", "h\\", "f:", "S_j_h", "s_>", "h~", "s_w", "S_>", "S_w", "s_h_w", "p\\:", "T:",
...
sonorants <- c("l", "l_0", "r", "r_0", "n_j", "w~", "m_w", "l`", "n", "m:", "r_j", "4", "J", "5", "l_j", "j", "N:", "m_j", "w", "l:", "m", "j:", "N", "n_jn", "J_+", "w_j", "n:", "r\\`", "mm", "nn", "ll", "rr", "ww", "jj", "r_w", "l_w", "r\\", "n_0", "J_0", "m_0", "n`", "w:", "Nm", "J:", "N_0", "H", "r:", "P", "n_t", "l_t", "L", "N_w",  "n_w", "j~", "r`", "m_p", "n_p", "")
...
fricatives <- c("z_j", "G", "z\\", "h", "z`", "K", "X", "B", "z", "S", "R", "X:", "x:", "C", "S_j", "R_j", "X_>", "x", "s", "s:", "s\\", "S:", "f_w", "T", "s_j", "s`", "B_j", "v_j", "j\\", "Z", "v", "r\\_r", "r\\:_r", "X:_w", "X\\", "?\\", "p\\", "X_w", "s\\:", "SS", "ss", "ff", "s_h", "S_h", "f_h", "s\\_h", "h\\", "D", "f:", "S_j_h", "s_>", "h~", "Z_w", "s_w", "S_>", "S_w", "T:", "R_w", "s_h_w", "p\\:", "z_w", "f_j", "f", "")
...
###       Data                  ###
###################################
initial_data <- load_data('../data/consonant_data.csv', filter_long = F, n = 30, outlier_mad = 30)

data <- initial_data %>% mutate(
  voicing = ifelse(
