...
fricatives <- c("_j", "z_j", "G", "z\\", "h", "z`", "K", "X", "B", "z", "S", "R", "X:", "x:", "C", "S_j", "R_j", "X_>", "x", "s", "s:", "s\\", "S:", "f_w", "T", "s_j", "s`", "B_j", "v_j", "j\\", "Z", "v", "r\\_r", "r\\:_r", "X:_w", "X\\", "?\\", "p\\", "X_w", "s\\:", "SS", "ss", "ff", "s_h", "S_h", "f_h", "s\\_h", "h\\", "D", "f:", "S_j_h", "s_>", "h~", "Z_w", "s_w", "S_>", "S_w", "T:", "R_w", "s_h_w", "p\\:", "z_w", "f_j", "f", "")
...
data <- initial_data %>% mutate(
  ...
  filter(!(sound_class %in% c("vowel", "geminate")))

data %>% group_by(sound_class, voicing) %>% count()
z_data %>% filter(grepl(":", ph))
